...
public:
    ...
    PeriodicStructure(Types::Vector3d dir1, Types::Vector3d dir2, Types::scalar h1, Types::scalar h2,
                      const Mesh::SurfaceMesh &base_mesh);

    // Selectors
    [[nodiscard]] const structure_matrix_t<Types::Vector3d> &get_origin_matrix() const noexcept { return origin_matrix; }
    [[nodiscard]] const Types::Vector3d &get_origin(Types::index i, Types::index j) const noexcept { return origin_matrix[i][j]; }
    [[nodiscard]] const Types::Vector3d &get_origin(Types::index i) const noexcept {
        const auto [fst, snd] = linear_to_double(i);
        return origin_matrix[fst][snd];
    }
    ...
    // Setters
    [[nodiscard]] mesh_t &get(Types::index index) noexcept { return basic_meshes[index]; }
    structure_matrix_t<Types::Vector3d> &get_origin_matrix() noexcept { return origin_matrix; }
    Types::Vector3d &get_origin(Types::index i) noexcept {
        const auto [fst, snd] = linear_to_double(i);
        return origin_matrix[fst][snd];
    }
...
PeriodicStructure<N1, N2>::calculate_origin_matrix(Types::Vector3d dir1, Types::Vector3d dir2, Types::scalar h1,
                                                   Types::scalar h2) const {
...
template <Types::index N1, Types::index N2>
PeriodicStructure<N1, N2>::PeriodicStructure(Types::Vector3d dir1, Types::Vector3d dir2, Types::scalar h1,
