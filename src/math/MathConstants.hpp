...
namespace EMW::Math::Constants {
    template<typename T>
    constexpr T PI = static_cast<T>(3.141592653589793238462643383279502884197169399375105820974944592307816406286208998670);
    template<typename T>
    constexpr T inverse_4PI = static_cast<T>(1) / (static_cast<T>(4) * PI<T>);

    constexpr auto i = Types::complex_d{0, 1};
}
