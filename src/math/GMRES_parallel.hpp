//
// Created by evgen on 08.10.2024.
//

#ifndef GMRES_PARALLEL_HPP
#define GMRES_PARALLEL_HPP
...
template <class matrixclass> class GMRES {
  ...
  public:
    ...
    int solver(double stopping_res, matrixclass *Matrix, mpi_doubleVector *rhs, int n, mpi_doubleVector *approx,
               int restartsize) {
  ...
  private:
    void givens_rotations(mpi_doubleVector v, doubleVector w, doubleMatrix R, doubleVector sinus, doubleVector cosinus,
                          int k);
