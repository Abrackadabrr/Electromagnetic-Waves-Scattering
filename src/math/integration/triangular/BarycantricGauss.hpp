...
#ifndef BARYCANTRICGAUSS_HPP
#define BARYCANTRICGAUSS_HPP

#include "types/Types.hpp"

namespace EMW::Math::Integration::Triangular::BarycentricGauss {
...
template <int dim>
struct Node {
    using point_t = Containers::array_d<dim + 1>;
    // барицентрические координаты (без последней координаты, которая
    // вычисляется по предыдущим)
    point_t point;
...
template <>
struct GaussianPoints<1, 1> : quadrature_utils::BasePoints<1, 1> {
...
template <>
struct GaussianPoints<1, 3> : quadrature_utils::BasePoints<1, 3> {
...
template <>
struct GaussianPoints<1, 5> : quadrature_utils::BasePoints<1, 5> {
...
template <>
struct GaussianPoints<1, 7> : quadrature_utils::BasePoints<1, 7> {
...
template <>
struct GaussianPoints<1, 9> : quadrature_utils::BasePoints<1, 9> {
...
template <>
struct GaussianPoints<1, 11> : quadrature_utils::BasePoints<1, 11> {
        ...
        nodes = {
            quadrature_utils::Node<Base::dim>{
                {static_cast<Types::scalar>(1) / static_cast<Types::scalar>(2) -
                 (static_cast<Types::scalar>(1) /
                  static_cast<Types::scalar>(2)) *
...
template <>
struct GaussianPoints<1, 13> : quadrature_utils::BasePoints<1, 13> {
...
template <>
struct GaussianPoints<1, 15> : quadrature_utils::BasePoints<1, 15> {
...
template <>
struct GaussianPoints<1, 17> : quadrature_utils::BasePoints<1, 17> {
...
template <>
struct GaussianPoints<2, 1> : quadrature_utils::BasePoints<2, 1> {
...
template <>
struct GaussianPoints<2, 2> : quadrature_utils::BasePoints<2, 2> {
...
template <>
struct GaussianPoints<2, 3> : quadrature_utils::BasePoints<2, 3> {
...
template <>
struct GaussianPoints<2, 4> : quadrature_utils::BasePoints<2, 4> {
...
template <>
struct GaussianPoints<2, 5> : quadrature_utils::BasePoints<2, 5> {
...
template <>
struct GaussianPoints<3, 1> : quadrature_utils::BasePoints<3, 1> {
...
template <>
struct GaussianPoints<3, 2> : quadrature_utils::BasePoints<3, 2> {
...
template <>
struct GaussianPoints<3, 3> : quadrature_utils::BasePoints<3, 3> {
...
template <>
struct GaussianPoints<3, 5> : quadrature_utils::BasePoints<3, 5> {
    ...
    static constexpr Containers::array<quadrature_utils::Node<Base::dim>, 14>
        nodes = {
            ...
            quadrature_utils::Node<Base::dim>{{l2, l2, l2},
                                              0.07349304311636194},
