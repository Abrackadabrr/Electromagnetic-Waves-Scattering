...
namespace SatelliteSystem::DefiniteIntegrals {
    ...
    namespace detail {
        ...
        decltype(extractIntegralTypes(std::declval<TypeTraits::return_type_of_t<Callable>>(),
        std::declval<TypeTraits::argument_tuple_type_of_t<Callable>>()));

        template <typename ArgsTuple, typename DeltaTuple, typename Points, indexType... indexes>
