...
then
  /media/evgen/SecondLinuxDisk1/IDEs/clion-2023.3.2/bin/ninja/linux/x64/ninja $targets_to_make ${EIGEN_MAKE_ARGS}
else
  /media/evgen/SecondLinuxDisk1/IDEs/clion-2023.3.2/bin/ninja/linux/x64/ninja $targets_to_make 
fi
exit $?
